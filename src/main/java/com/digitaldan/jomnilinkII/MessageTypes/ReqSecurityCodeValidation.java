...
public class ReqSecurityCodeValidation implements Message {
	 ...
	 * 
	 * � Request security code validation � Security code validation
	 * 
	 * 
	 * REQUEST SECURITY CODE VALIDATION
	 * 
	 * Start character 0x21 Message length 0x06 Message type 0x26 Data 1 area number
	 * (1-8) Data 2 first digit of code Data 3 second digit of code Data 4 third
	 * digit of code Data 5 fourth digit of code CRC 1 varies CRC 2 varies
	 * 
