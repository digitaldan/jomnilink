...
public class ReqAudioSourceStatus implements Message {
	 ...
	 * other feedback from the specified source. Start character 0x21 Message length
	 * 0x05 Message type 0x30 Data 1 source number (1-8) Data 2 position CRC 1
	 * varies CRC 2 varies Expected reply AUDIO SOURCE STATUS
	 *
